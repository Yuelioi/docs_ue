...
试图使用指定的清单 URL 下载清单文件。一旦成功，它将返回一个代表远程内容的对象。此对象可查询其他信息，如总内容大小、下载大小等。用户可以选择下载和安装远程内容。

目标是移动补丁库

## 图示

![](/uploads/projects/ue-bluprint/20221218-20062705.png)

## Inputs

在。执行。

远程清单 URL。String. : 可以下载清单文件的 URL。(http://my-server.com/awesomecontent.manifest)。

云 URL。字符串。 : 可以下载内容块数据的 URL。(http://my-server.com/awesomecontent/clouddir)。
