...
返回在开始和结束时间戳之间发生的 onsets。

目标是 Onset NRT

## 图示

![](/uploads/projects/ue-bluprint/20221218-18082479.png)
...
在结束秒数中。Float (single-precision).

在通道中。整数。

## Outputs

Out Onset Timestamps: Float（单精度）的数组。

Out Onset Strengths: Float (single-precision)s 的数组。
