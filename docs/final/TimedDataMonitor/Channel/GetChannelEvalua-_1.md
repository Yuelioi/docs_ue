...
![](/uploads/projects/ue-bluprint/20221218-21122732.png)
...
Return Value: Float (single-precision). Returns the standard deviation of the distance, in seconds, between evaluation time and newest sample.
