...
返回评估时间与最新样本之间的平均距离，单位是秒。

目标是定时数据监控子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-21122598.png)
...
返回值。浮点数（单精度）。返回评估时间和最新样本之间的平均距离，单位是秒。
...
Return Value: Float (single-precision). Returns the average distance, in seconds, between evaluation time and newest sample.
