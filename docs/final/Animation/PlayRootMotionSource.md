...
可通过授权调用。播放 "带外 "动画：例如，直接在同步状态上设置 RootMotionSourceID，而不是待定的 InputCmd。这类似于外部代码传送角色（在核心模拟功能之外）。

目标是模拟的根运动组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-17502192.png)
...
源。Mock Root Motion Source 对象参考。
