# IsPlayingNetworkedRootMotionMont-

如果我们现在正在播放 Root Motion，通过 RootMotionMode == ERootMotionMode::RootMotionFromMontagesOnly 的蒙太奇，则为真。这意味着网络化根部运动的代码路径已经启用。

目标是字符

## 图示

![](/uploads/projects/ue-bluprint/20221218-17501089.png)
...
返回值。布尔值。如果我们现在正在播放 Root Motion，通过 RootMotionMode == ERootMotionMode::RootMotionFromMontagesOnly 的蒙太奇，则为真。这意味着网络化根部运动的代码路径已经启用。
