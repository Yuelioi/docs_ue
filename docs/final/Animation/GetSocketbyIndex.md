...
按索引返回一个套接字。最大的索引是 NumSockets()。首先访问网格的套接字，然后是骨架。

目标是骨架网

## 图示

![](/uploads/projects/ue-bluprint/20221218-17500285.png)
...
返回值。骨骼网套接字对象参考。按索引返回一个套接字。最大索引为 NumSockets()。首先访问的是网格套接字，然后是骨架。
