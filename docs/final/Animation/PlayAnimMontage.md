...
在角色网格上播放动画蒙太奇。返回动画蒙太奇的长度（秒），如果播放失败，则返回 0.f。\*

目标是角色

## 图示

![](/uploads/projects/ue-bluprint/20221218-17502078.png)
...
Start Section Name: 名称.

## Outputs

出来。执行：执行。

返回值。浮点数（单精度）。在角色网格上播放动画蒙太奇。返回动画蒙太奇的长度（秒），如果播放失败，则返回 0.f。\*.
