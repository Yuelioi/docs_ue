...
给出一个从 0 到花键持续时间的时间，返回花键在那里的上升向量。

目标是花键组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-21011636.png)
...
返回值。向量。给出一个从 0 到花键持续时间的时间，返回花键的向上向量。
...
Return Value: Vector. Given a time from 0 to the spline duration, return the spline's up vector there..
