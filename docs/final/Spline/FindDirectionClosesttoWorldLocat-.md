# FindDirectionClosesttoWorldLocat-

给定一个位置，在世界空间中，返回一个最接近该位置的花键切线的单位方向矢量。

目标是花键组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-21001001.png)
...
返回值。向量。给定一个位置，在世界空间中，返回一个最接近该位置的花键切线的单位方向向量。
