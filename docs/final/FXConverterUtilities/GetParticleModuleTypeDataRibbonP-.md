# GetParticleModuleTypeDataRibbonP-
...
Out Max Particle in Trail Count:整数。

停用时的死亡轨迹。布尔值。

Out Clip Source Segment。布尔型。
...
Out Tangent Spawning Scalar。Float（单精度）。

Out Render Geometry:Boolean.

Out Render Spawn Points:布尔值。

Out Render Tangents:布尔值。
