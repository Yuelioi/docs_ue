...
目标是 Animation Curve Identifier Extensions。

## 图示

![](/uploads/projects/ue-bluprint/20221218-18340649.png)
...
曲线类型。ERawCurveTrackTypes 枚举。要检索的曲线标识符的类型。

## Outputs

输出。执行：执行。

返回值。Animation Curve Identifier 结构的数组。FAnimationCurveIdentifier 实例的数组，如果操作成功，每个实例代表一条独特的曲线，否则就是空数组。
