...
将一个暴露的引脚添加到由这个控制的图形中。

目标是 Rig VMController

## 图示

![](/uploads/projects/ue-bluprint/20221218-20415207.png)
...
Return Value: Name. Adds an exposed pin to the graph controlled by this.
