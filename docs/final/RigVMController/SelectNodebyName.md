...
在图中通过名称选择一个单一的节点。这将导致一个 NodeSelected / NodeDeselected 修改事件。

目标是 Rig VMController

## 图示

![](/uploads/projects/ue-bluprint/20221218-20432598.png)
...
返回值。布尔值。通过名称选择图中的一个节点。这将导致一个 NodeSelected / NodeDeselected 修改事件。
