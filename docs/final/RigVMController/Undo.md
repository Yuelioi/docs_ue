...
取消堆栈上的最后一个动作。注意：这应该只用于单元测试，使用 GEditor 的主 Undo 方法代替。

目标是 Rig VMController

## 图示

![](/uploads/projects/ue-bluprint/20221218-20440373.png)
...
返回值。布尔值。取消堆栈中的最后一个动作。注意：这应该只用于单元测试，用 GEditor 的主撤消方法代替。
