...
设置图形中一个节点的颜色。这将引起一个 NodeColorChanged 修改事件。

目标是 Rig VMController

## 图示

![](/uploads/projects/ue-bluprint/20221218-20433999.png)
...
返回值。布尔值。设置图形中一个节点的颜色。这将引起一个 NodeColorChanged 修改事件。
...
Return Value: Boolean. Sets the color of a node in the graph.. This causes a NodeColorChanged modified event..
