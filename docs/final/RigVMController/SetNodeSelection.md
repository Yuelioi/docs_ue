...
选择给定的节点。这可能会引起几个NodeDeselected修改事件。

目标是Rig VMController

## 图示

![]($-20221218-20434952.png)
...
返回值。布尔值。选择给定的节点。这可能会引起几个NodeDeselected修改事件。
...
Return Value: Boolean. Selects the nodes given the selection. This might cause several NodeDeselected modified event..
