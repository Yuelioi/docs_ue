...
设置阵列引脚的大小。这会引起PinArraySizeChanged修改事件。

目标是Rig VMController

## 图示

![]($-20221218-20432712.png)
...
返回值。布尔值。设置数组引脚的大小。这会引起PinArraySizeChanged修改事件。
...
Return Value: Boolean. Sets the size of the array pin. This causes a PinArraySizeChanged modified event..
