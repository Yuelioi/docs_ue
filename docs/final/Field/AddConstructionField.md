...
AddConstructionField。这个函数将向物理线程派发一条命令，以应用用户定义的场网的通用评估。这个命令将被用于构建脚本，以设置一些粒子属性（锚......）。关于如何使用场网络重新创建上述通用场的变体的例子，请参见文件，。
...
![](/uploads/projects/ue-bluprint/20221218-18593861.png)
