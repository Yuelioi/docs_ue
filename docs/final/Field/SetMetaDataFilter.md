...
位置类型。EFieldPositionType Enum。用来计算样本位置的位置类型。
...
Target: Meta Data Filter Object Reference.

State Type: EFieldFilterType Enum. State type used to select the state particles on which the field will be applied.
