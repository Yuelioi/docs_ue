...
![](/uploads/projects/ue-bluprint/20221218-18595936.png)
...
左边的字段。字段节点基本对象参考。要处理的输入字段 A。

右边字段。字段节点基本对象参考。要处理的输入字段 B。

字段操作。EFieldOperationType 枚举。你想在 2 个字段之间进行的数学运算的类型。
