...
如果你想在应用程序执行期间改变原点或 CRS 定义属性，你需要调用这个函数来更新内部转换缓存。请注意，这不是一个推荐的做法，因为它不会相应地移动级别的角色。不过，如果你自己重新设置你的角色，或者你想改变一个用于显示坐标的 CRS，那么就会很有用。

目标是地理参考系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-19141338.png)
