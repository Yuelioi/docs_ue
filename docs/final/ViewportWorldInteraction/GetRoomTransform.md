...
获取校准后的 VR 房间原点的世界空间变换。当使用坐着的 VR 设备时，这感觉就像摄像机的世界变换（在任何 HMD 位置或旋转调整被应用之前）。

目标是视口世界的相互作用

## 图示

![](/uploads/projects/ue-bluprint/20221218-21253789.png)
...
返回值。变换。获取校准后的 VR 房间原点的世界空间变换。当使用坐着的 VR 设备时，这将感觉到摄像机的世界变换（在任何 HMD 位置或旋转调整被应用之前）。
