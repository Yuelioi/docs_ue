...
返回 NotifyEvent 的持续时间，对于 Anim Notify 状态来说，只有非零值。

目标是动画蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-17512824.png)
...
返回值。浮点数（单精度）。返回 NotifyEvent 的持续时间，对于 Anim Notify 状态来说只有非零值。
