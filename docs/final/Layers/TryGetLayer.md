...
试图获取所提供的图层名称的 ULayer 对象。

目标是分层子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-19381389.png)
...
层名。名称（通过引用）。要检索的 ULayer 对象的层的名称。
...
返回值。布尔值。如果为真，找到了一个有效的 ULayer 对象，并设置为 OutLayer；如果为假，没有找到一个有效的 ULayer 对象，并且无效的设置为 OutLayer。
