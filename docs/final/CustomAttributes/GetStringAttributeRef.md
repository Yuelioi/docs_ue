...
![](/uploads/projects/ue-bluprint/20221218-18341945.png)
...
输出值。字符串（通过引用）。(参考）如果找到的话，检索的属性值，否则被设置为 DefaultValue。
...
Out Value: String (by ref). (reference) Retrieved attribute value if found, otherwise is set to DefaultValue.
