...
![](/uploads/projects/ue-bluprint/20221218-18342184.png)
...
输出值。Transform (by ref). (参考）如果找到的话，检索的属性值，否则被设置为 DefaultValue。
...
Out Value: Transform (by ref). (reference) Retrieved attribute value if found, otherwise is set to DefaultValue.
