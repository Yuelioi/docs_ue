...
将角色的 RootComponent 设置到指定的相对位置。

目标是演员

## 图示

![](/uploads/projects/ue-bluprint/20221218-21152778.png)
...
New Relative Location: Vector. New relative location of the actor's root component.
