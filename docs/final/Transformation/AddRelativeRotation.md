...
添加一个 delta，即组件相对于其父体的旋转。

目标是场景组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-21143438.png)
...
Delta Rotation: Rotator. Change in rotation of the component relative to is parent..
