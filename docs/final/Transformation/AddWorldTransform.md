...
为世界空间中的组件的变换添加一个delta。忽略比例，将其设置为（1,1,1）。

目标是场景组件

## 图示

![]($-20221218-21143780.png)
...
三角洲变换。变换（通过参考）。该组件在世界空间中的变换变化。刻度被忽略。
...
Delta Transform: Transform (by ref). Change in transform in world space for the component. Scale is ignored..
