...
将角色的 RootComponent 设置为指定的相对变换。

目标是演员

## 图示

![](/uploads/projects/ue-bluprint/20221218-21153108.png)
...
New Relative Transform: Transform (by ref). New relative transform of the actor's root component.
