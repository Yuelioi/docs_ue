...
![](/uploads/projects/ue-bluprint/20221218-19002191.png)
...
通配符。字符串。通配符，可用于查找名称中带有特定文字的文件或目录。例如，.png 用于查找所有以 png 扩展名结尾的文件，images\*用于查找任何带有 "images "字样的文件。 否则，FileExtension 可以是.EXT 或只是 EXT 的形式，只有带有该扩展名的文件会被返回。不适用于目录。
