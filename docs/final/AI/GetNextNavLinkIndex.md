...
返回给定控制器的当前路径的下一个导航链接的路径索引。如果没有路径或没有进入的导航链接，返回 INDEX_NONE。

目标是 AIBlueprint Helper Library

## 图示

![](/uploads/projects/ue-bluprint/20221218-17464606.png)
...
返回值。整数。返回给定控制器的当前路径的下一个导航链接的路径索引。如果没有路径或没有进入的导航链接，返回 INDEX_NONE。
