...
使 AI 走向指定的 Dest 位置，中止任何主动的路径跟踪。

目标是 AIController

## 图示

![](/uploads/projects/ue-bluprint/20221218-17473299.png)
...
重叠时停止。布尔值。将小卒的半径添加到 AcceptanceRadius。
...
过滤器类。导航查询过滤器类参考。导航过滤器用于寻路调整。如果没有指定 DefaultNavigationFilterClass 将被使用。
