# GetRivertoOceanTransitionMateria-

返回河流到海洋的过渡材料实例（供内部使用，请使用 AWaterBodyRiver 代替）。

目标是水体部分

## 图示

![](/uploads/projects/ue-bluprint/20221218-20363594.png)
...
返回值。材质实例动态对象参考。返回河流到海洋的过渡材料实例（供内部使用，请使用 AWaterBodyRiver 代替）。
