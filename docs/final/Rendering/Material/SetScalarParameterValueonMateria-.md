# SetScalarParameterValueonMateria-

在 SkeletalMesh 的材料集中，将所有出现的带有 ParameterName 的标量材料参数设置为 ParameterValue。

目标是网格组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-20382683.png)
...
Parameter Value: Float (single-precision).
