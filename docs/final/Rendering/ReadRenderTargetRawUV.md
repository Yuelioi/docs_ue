...
令人难以置信的低效和缓慢的操作!使用 UV[0,1]x[0,1]坐标从渲染目标中按原样读取一个值。

目标是 Kismet Rendering Library

## 图示

![](/uploads/projects/ue-bluprint/20221218-20384547.png)
...
返回值。线性颜色结构。令人难以置信的低效和缓慢的操作!使用 UV[0,1]x[0,1]坐标从渲染目标中读取一个原样的值。
