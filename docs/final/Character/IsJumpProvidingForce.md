...
如果跳转正在积极地提供一个力，例如当跳转键被按住，并且它被按住的时间小于 JumpMaxHoldTime，则为真。见。CharacterMovement->IsFalling

目标是角色

## 图示

![](/uploads/projects/ue-bluprint/20221218-18154288.png)
...
返回值。布尔值。如果跳跃正在主动提供一个力，例如，当跳跃键被按住，并且被按住的时间小于 JumpMaxHoldTime，则为真。参见 CharacterMovement->IsFalling。
