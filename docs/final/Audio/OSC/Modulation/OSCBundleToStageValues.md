...
将 OSCBundle 转换为控制总线值和混合路径，它来自于此。

目标是 OSCModulation 混合状态

## 图示

![](/uploads/projects/ue-bluprint/20221218-18061137.png)
...
总线路径。OSCAddress 结构的阵列。

总线类名称。字符串的数组。

总线值。声音调制混合值结构的数组。将 OSCBundle 转换为控制总线值和混合路径，它来自于此。
