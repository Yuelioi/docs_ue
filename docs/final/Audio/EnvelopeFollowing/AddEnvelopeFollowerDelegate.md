...
当包络追随在该子混音上被启用时，将包络追随者委托添加到该子混音中。

目标是声音子混音

## 图示

![]($-20221218-18044556.png)
...
Submix Envelope BP时：委托（通过参考）。当新的包络数据可用时触发的事件。 
...
On Submix Envelope BP: Delegate (by ref). Event to fire when new envelope data is available..  
