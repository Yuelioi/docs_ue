...
设置过滤算法。设置滤波器算法。目标是Submix Effect Filter Preset。

Set Filter Cutoff Frequency. 设置基础滤波器的截止频率。目标是子混音效果滤波器预设。

设置滤波截止频率Mod。设置调制滤波器的截止频率。目标是Submix Effect Filter Preset。

设定滤波器的Q值：目标是子混音效果滤波器预置。

设置滤波器的Q值。设置滤波器的Q值：目标是子混音效果滤波器预置。

设置滤波类型。设定滤波器的类型。目标是子混音效果滤波器预设。

设置设置。设置所有的滤波器效果设置。目标是Submix Effect Filter Preset。
