...
设置与所提供的 Wave 名称相匹配的参数。为方便/向后兼容而提供，与 SoundCues（参数接口支持任何对象，由查询它的系统决定是否是有效类型）。

目标是音频组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-18071922.png)
...
在 Wave 中。Sound Wave Object Reference. 要设置的波值。
