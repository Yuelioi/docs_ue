...
![](/uploads/projects/ue-bluprint/20221218-21202941.png)
...
在父母。Rig Element Key Structure.新控件的（可选）父控件。如果你不需要一个父级，请传递 FRigElementKey()。
...
返回值。Rig Element Key 结构。新创建的控件的密钥。
