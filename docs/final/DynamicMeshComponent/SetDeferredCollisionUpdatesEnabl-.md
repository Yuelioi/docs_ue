...
设置 bDeferCollisionUpdates 的值，当启用时，每次网格变化时不会自动重新计算碰撞。

目标是动态网格组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-18461260.png)
...
立即更新：布尔值。如果为真，如果 bEnabled=false，就会调用 UpdateCollision(true)，即强制重建碰撞。
