...
设置已启用。设置已启用。目标是音频游戏音量。

设置外部LPF。设置Exterior LPF：目标是过滤器。

设置外部音量。设置外部音量。目标是衰减。

设置室内LPF。设置室内LPF：目标是滤波。

设置室内音量。设置内部音量。目标是衰减。

设置优先权。设置优先权。目标是Audio Gameplay Volume Component Base。

设置子混音发送设置。设置子混音发送设置。目标是子混音发送。
