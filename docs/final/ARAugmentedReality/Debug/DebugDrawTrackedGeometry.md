...
给出一些被增强现实系统跟踪的真实世界的几何图形，在屏幕上画出它，以达到调试的目的（初级）。

目标是 ARBlueprint 库

## 图示

![](/uploads/projects/ue-bluprint/20221218-17562564.png)

## Inputs

在。执行。

追踪的几何体。ARTracked Geometry 对象参考。
...
Tracked Geometry: ARTracked Geometry Object Reference.

Color: Linear Color Structure.

Outline Thickness: Float (single-precision).
