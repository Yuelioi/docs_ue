...
在所有提供的 MeshComponents 中找到 MeshToBeReplaced 的引用，然后用 NewMesh 替换它。编辑器模式下，不应该在播放。

目标是静态网格编辑器子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-21040139.png)
...
网格组件。静态网格组件对象参考数组。列表中的 MeshComponent 可供搜索。
