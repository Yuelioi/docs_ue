...
![](/uploads/projects/ue-bluprint/20221218-17305459.png)
...
Effect Context: Gameplay Effect Context Handle 结构。
...
Replicate Location when Using Minimal Rep Proxy: Boolean（布尔）。
