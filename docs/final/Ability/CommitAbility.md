...
试图投入能力（花费资源，等等）。这是我们最后一次失败的机会。覆盖 ActivateAbility 的子类必须自己调用这个功能。

目标是游戏能力

## 图示

![](/uploads/projects/ue-bluprint/20221218-17302463.png)
...
返回值。布尔值。试图投入该能力（花费资源等）。这是我们最后一次失败的机会。覆盖 ActivateAbility 的子类必须自己调用它！。
