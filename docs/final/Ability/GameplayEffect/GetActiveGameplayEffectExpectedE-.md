# GetActiveGameplayEffectExpectedE-

返回一个给定的 GameplayEffect 的预期结束时间（我们认为 GE 会在什么时候结束）（注意在这之前有人可能会删除或改变它！）。

目标是能力系统蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-17312974.png)
...
返回值。浮点数（单精度）。返回一个给定的 GameplayEffect 的预期结束时间（我们认为 GE 会在什么时候结束）（注意在这之前有人可能会删除或改变它！）。
