# GetActiveGameplayEffectStackCoun-

返回当前活动的游戏效果的堆栈计数。如果 GameplayEffect 不再有效，将返回 0。

目标是能力系统蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-17313227.png)
...
返回值。整数。返回当前活动游戏效果的堆栈计数。如果 GameplayEffect 不再有效，将返回 0。
