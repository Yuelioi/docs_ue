...
这个效果的实例现在将赋予这个效果所应用的对象以新的游戏标记（NewGameplayTags）。

目标是能力系统蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-17312096.png)
...
New Gameplay Tags: Gameplay Tag Container 结构。

## Outputs

Out: 执行：执行。

返回值。Gameplay Effect Spec Handle 结构。这个效果的实例现在将赋予这个效果所应用的对象以新的游戏标记（NewGameplayTags）。
