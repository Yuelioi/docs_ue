# GetActiveGameplayEffectStackLimi-

返回活动的 GameplayEffect 的堆栈极限计数。如果 GameplayEffect 不再有效，将返回 0。

目标是能力系统蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-17313369.png)
...
返回值。整数。返回一个活动的游戏效果的堆栈极限计数。如果该 GameplayEffect 不再有效，将返回 0。
