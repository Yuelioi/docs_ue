...
![](/uploads/projects/ue-bluprint/20221218-18335938.png)
...
曲线标识。Animation Curve Identifier 结构（通过 ref）。要设置按键的变换曲线的标识符。

Transform Values（变换值）。变形的数组。用来替换现有值的变换值。
