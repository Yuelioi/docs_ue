...
根据 DesiredScreenWidth/Height 和当前的屏幕分辨率，获取期望的分辨率质量。

目标是游戏用户设置

## 图示

![](/uploads/projects/ue-bluprint/20221218-20565890.png)
...
返回值。Float（单精度）。获取基于 DesiredScreenWidth/Height 和当前屏幕分辨率的期望分辨率质量。
