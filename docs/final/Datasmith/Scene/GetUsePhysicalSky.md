...
物理天空可以用大量的模式生成，比如材质、灯光等等。这就是为什么它被添加为静态的原因，只要启用它就可以了。请注意，如果使用HDRI环境，这个功能会被禁用。
...
返回值。布尔值。物理天空可以以大量的模式生成，如材料、灯光等，这就是为什么它被添加为静态的原因，只要启用它就可以了。请注意，如果使用HDRI环境，这个功能将被禁用。
