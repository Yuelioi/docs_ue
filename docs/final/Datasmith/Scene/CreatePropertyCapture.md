...
创建一个新的属性捕获并将其添加到此绑定中

目标是 Datasmith Actor Binding Element。

## 图示

![](/uploads/projects/ue-bluprint/20221218-18394659.png)
...
返回值。Datasmith 属性捕捉元素对象参考。创建一个新的属性捕获并将其添加到这个绑定中。
...
Return Value: Datasmith Property Capture Element Object Reference. Create a new property capture and add it to this binding.
