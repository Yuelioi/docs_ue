...
创建一个新的 MeshActor，并将其添加到 Datasmith 场景中。

目标是 Datasmith 场景元素基础

## 图示

![](/uploads/projects/ue-bluprint/20221218-18394425.png)
...
返回值。Datasmith Mesh Actor 元素对象参考。创建一个新的 MeshActor 并将其添加到 Datasmith 场景中。
