...
找到与指定标签名称相关的第一个对象绑定 ID（通过 RMB->在序列器中的对象绑定上显示设置）。

目标是电影场景序列

## 图示

![](/uploads/projects/ue-bluprint/20221218-20540039.png)
...
返回值。电影场景对象绑定 ID 结构。查找与指定标签名称相关的第一个对象绑定 ID（通过 RMB->Expose on Object bindings from within sequencer 设置）。
