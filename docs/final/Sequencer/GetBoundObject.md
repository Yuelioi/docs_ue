...
解决这个子序列中与指定 ID 相关的第一个有效绑定。注意：:ObjectBinding 应该从与这个 Sequence Director 拥有的 Sequence 相同的序列中构建（见 GetSequenceBinding 节点）。

目标是水平序列主任

## 图示

![](/uploads/projects/ue-bluprint/20221218-20482617.png)
