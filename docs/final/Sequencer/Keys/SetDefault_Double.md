...
设置这个通道的默认值，当没有按键时应该使用。自动设置 bHasDefaultValue 为真。

目标是电影场景脚本的双通道

## 图示

![](/uploads/projects/ue-bluprint/20221218-20502679.png)
...
In Default Value: Float (double-precision).
