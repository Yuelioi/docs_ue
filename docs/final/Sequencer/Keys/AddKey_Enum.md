...
![](/uploads/projects/ue-bluprint/20221218-20483702.png)
...
返回值。电影场景脚本的字节密钥对象参考。在指定时间用指定的值创建的键。
...
New Value: Byte. The value that this key should be created with..
...
Return Value: Movie Scene Scripting Byte Key Object Reference. The key that was created with the specified values at the specified time..
