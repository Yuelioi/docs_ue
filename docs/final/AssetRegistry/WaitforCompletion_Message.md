...
等待扫描完成。如果在编辑器启动时，在 OnPostEngineInit 之前调用，并且有任何资产使用了尚未加载的插件模块中的类，WaitForCompletion 将无声地返回，这些资产仍然没有被收集起来。

目标是资产注册表

## 图示

![](/uploads/projects/ue-bluprint/20221218-18011809.png)
