...
获取蒙太奇的播放率。如果蒙太奇参考是 NULL，任何活动蒙太奇的播放速率将被返回。如果蒙太奇没有在播放，将返回 0。

目标是 Anim Instance

## 图示

![](/uploads/projects/ue-bluprint/20221218-20070345.png)
...
返回值。浮点数（单精度）。获取蒙太奇的播放速率。如果蒙太奇引用为 NULL，将返回任何活动蒙太奇的播放速率。如果蒙太奇没有在播放，将返回 0。
