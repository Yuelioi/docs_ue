...
将一个蒙太奇与另一个动画实例的蒙太奇同步。两个蒙太奇都必须已经在播放
...
蒙太奇跟随者。Anim Montage Object Reference. : 将跟随OtherAnimInstance中的领导者的蒙太奇。

其他动画实例:Anim Instance Object Reference. : 我们想同步到的另一个动画实例。可以设置为自己。

蒙太奇领袖。Anim Montage Object Reference. : 我们想在其他动画实例中跟随的蒙太奇。  
