...
A: Set of Wildcards. Starting set.

B: Set of Wildcards. Set of elements to remove from set A.  

## Outputs

Out: Exec.

Result: Set of Wildcards. Set containing all elements in A that are not found in B.
