...
只设置当前的语言环境（用于国际化）。注意：除非你在做一些高级的事情，否则你可能想用 SetCurrentLanguageAndLocale 或 SetCurrentCulture 代替。

目标是 Kismet 国际化库

## 图示

![](/uploads/projects/ue-bluprint/20221218-14262317.png)

## Inputs

在。Exec.

文化。字符串。要设置的地域，作为一个 IETF 语言标签（例如，"zh-Hans-CN"）。
