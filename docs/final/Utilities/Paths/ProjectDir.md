...
通过查看 FApp::GetProjectName()返回当前项目的基本目录。这通常是安装时的一个子目录。根目录，可以在命令行上重写，以允许自带 mod 支持。

目标是蓝图路径库

## 图示

![](/uploads/projects/ue-bluprint/20221218-14281760.png)
...
Return Value: String. base directory.
