...
转换一个双数->字符串，以AppendTo+Prefix+InDouble+Suffix的形式创建一个新字符串。

目标是Kismet字符串库

## 图示

![]($-20221218-14291872.png)
...
In Double: Float（双精度）。要转换的双倍值。

后缀。字符串。后缀，用于附加到转换字符串的末尾。 
...
In Double: Float (double-precision). The double value to convert.
