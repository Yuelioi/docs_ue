...
如果屏幕阅读器用户的文本到语音是静音的，则返回 true。否则返回 false。如果提供的用户 ID 不存在，将返回 false。

目标是 Slate 屏幕阅读器引擎子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-20584891.png)

## Inputs

目标。石板屏幕阅读器引擎子系统对象参考。

读屏器用户标识。整数。屏幕阅读器的用户 ID，用于检查文字转语音是否被静音。
