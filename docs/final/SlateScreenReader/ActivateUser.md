...
![](/uploads/projects/ue-bluprint/20221218-20584089.png)
...
读屏器用户标识。整数。请求激活的读屏器用户的用户 ID。

## Outputs

出：执行。

返回值。读屏器回复结构。如果读屏器用户被成功激活，返回 FScreenReaderReply::Handled()。否则返回 FScreenReaderReply::Unhandled()。
