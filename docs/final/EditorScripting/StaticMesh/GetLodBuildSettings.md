...
![](/uploads/projects/ue-bluprint/20221218-18540517.png)
...
Lod 索引。整数。我们得到的 LOD 的减少设置。

## Outputs

出：执行。

Out Build 选项。网格构建设置结构。构建设置是我们复制构建选项的地方。
...
Out Build Options: Mesh Build Settings Structure. The build settings where we copy the build options..
