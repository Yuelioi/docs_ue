...
检查给定集合中的命令是否可以被执行。这也将在全局范围内检查 CanExecuteCommands。

目标是 UICommands 脚本子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-18483608.png)
...
返回值。布尔值。检查给定集合中的命令是否可以被执行。这也将在全局范围内检查 CanExecuteCommands。
