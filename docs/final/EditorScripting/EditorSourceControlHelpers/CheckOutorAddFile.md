...
使用当前设置的源码控制提供者来检出文件或将其标记为添加。注意：阻断，直到行动完成。

目标是源代码控制帮助器

## 图示

![](/uploads/projects/ue-bluprint/20221218-18500171.png)

## Inputs

在。执行。

在文件中：字符串。要检出/添加的文件 - 可以是完全合格的路径、相对路径、长包名称、资产路径或导出文本路径（通常存储在剪贴板上）。
