...
使用当前设置的源码控制提供者，将一个文件或目录同步到头部修订。注意：阻断，直到动作完成。

目标是源代码控制帮助器

## 图示

![](/uploads/projects/ue-bluprint/20221218-18502357.png)

## Inputs

在。执行。

在文件中：字符串。要同步的文件或目录 - 可以是完全合格的路径、相对路径、长包名称、资产路径或导出文本路径（通常存储在剪贴板上）。
