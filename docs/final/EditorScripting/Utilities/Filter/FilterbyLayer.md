...
![](/uploads/projects/ue-bluprint/20221218-18542290.png)

## Inputs

在。执行。

目标数组。Actor 对象的数组 引用。要过滤的 Actor 数组。该数组将不会改变。

层名。名称。行为者所属的层的确切名称。

过滤器类型。EEditorScriptingFilterType 枚举。如果尊重条件，应包括或不包括数组的项目。
...
Layer Name: Name. The exact name of the Layer the actor belongs to..
