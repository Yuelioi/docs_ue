...
如果这个演员可以在编辑器中的关卡中永远被选中，则返回 true。可以被特定的演员覆盖，使他们无法被选中。

目标是演员

## 图示

![](/uploads/projects/ue-bluprint/20221218-18463927.png)
...
返回值。布尔值。如果这个演员可以在编辑器中的关卡中永远被选中，则返回 true。可以被特定的演员覆盖，使其不能被选中。
