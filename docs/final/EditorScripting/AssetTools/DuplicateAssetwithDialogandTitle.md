...
打开一个资产选择器对话框，用指定的名称和路径创建一个资产。使用 OriginalObject 作为复制源。使用 DialogTitle 作为对话框的标题。

目标是资产工具

## 图示

![](/uploads/projects/ue-bluprint/20221218-18474536.png)
...
返回值。对象参考。打开一个资产选择器对话框，用指定的名称和路径创建一个资产。使用 OriginalObject 作为复制源。使用 DialogTitle 作为对话框的标题。
