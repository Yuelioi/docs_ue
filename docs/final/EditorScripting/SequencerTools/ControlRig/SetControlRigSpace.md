...
![](/uploads/projects/ue-bluprint/20221218-18530985.png)
...
在控制钻机中。控制装置对象参考。控制 Rig 与控制\*。

在控制名称。名称。控制的名称 \*.

在空间钥匙。钻机元素钥匙结构（由参考）。控制\*的新空间。

在时间上。帧数结构。时间改变空间。\*.

时间单位。ESequenceTimeUnit 枚举。InTime 的单位，可以是显示速率或刻度分辨率。
