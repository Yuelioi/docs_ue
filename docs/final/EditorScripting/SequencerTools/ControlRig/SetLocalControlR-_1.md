...
在特定时间设置 ControlRig 控制的欧拉变换值

目标是 Control Rig Sequencer Editor Library

## 图示

![](/uploads/projects/ue-bluprint/20221218-18531525.png)
...
控制名称。名称。控件的名称，应该是一个 EulerTransform 控件。
...
Values: Array of Euler Transform Structures. to set at those times.
