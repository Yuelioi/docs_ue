...
In Bone Name: Name. Name of bone to adjust constraint ranges for.

Swing 1Limit Angle: Float (single-precision). Size of limit in degrees, 0 means locked, 180 means free.
