...
创建一个空的 StaticMeshDescription 对象，以便在运行时描述一个静态网格。

目标是静止的网格

## 图示

![](/uploads/projects/ue-bluprint/20221218-21030262.png)
...
返回值。静态网格描述对象参考。创建一个空的 StaticMeshDescription 对象，用于在运行时描述静态网格。
