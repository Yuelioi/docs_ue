...
获得一个指定权重的随机机会。权重的范围是 0.0 - 1.0 例如，.权重=.6 返回值=60%的时间为真

目标是 Kismet 数学图书馆

## 图示

![](/uploads/projects/ue-bluprint/20221218-19533721.png)
...
返回值。布尔值。获得一个具有指定权重的随机机会。权重的范围是 0.0 - 1.0 例如，.权重=.6 返回值=60%的时间为真。
