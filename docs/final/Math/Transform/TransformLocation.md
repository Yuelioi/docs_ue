...
通过提供的变换来变换一个位置。例如，如果 T 是一个物体的变换，这将把一个位置从本地空间变换到世界空间。

目标是 Kismet 数学图书馆

## 图示

![](/uploads/projects/ue-bluprint/20221218-19554983.png)
...
返回值。矢量。通过提供的变换来变换一个位置。例如，如果 T 是一个物体的变换，这将把一个位置从本地空间变换到世界空间。
