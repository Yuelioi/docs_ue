...
![](/uploads/projects/ue-bluprint/20221218-21190662.png)
...
返回值。Rig Element Key Structure.返回第一个父元素。
...
Return Value: Rig Element Key Structure. Returns the first parent element.
