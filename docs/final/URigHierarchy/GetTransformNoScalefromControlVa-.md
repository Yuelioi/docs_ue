# GetTransformNoScalefromControlVa-

返回一个钻机控制值中包含的 FTTransformNoScale 值。

目标是钻机等级制度

## 图示

![](/uploads/projects/ue-bluprint/20221218-21193874.png)
...
返回值。Transform No Scale 结构。转换后的 FTTransformNoScale 值。
