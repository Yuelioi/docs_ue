...
试图将 HandlesToMove 数组中的所有子对象重新 parent 到新的父句柄。

目标是子对象数据子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-21060512.png)
...
Handles to Move: Array of Subobject Data Handle Structures.
