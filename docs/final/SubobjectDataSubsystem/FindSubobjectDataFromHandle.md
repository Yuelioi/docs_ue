...
试图为一个给定的句柄找到子对象数据。OutData 只有在该函数返回真时才有效。

目标是子对象数据子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-21055506.png)

## Inputs

目标。子对象数据子系统对象参考。

手柄。子对象数据手柄结构（通过引用）。你想获得的子对象数据的句柄。

## Outputs

输出数据。子对象数据结构。对要填充的子对象数据的引用。

返回值。布尔值。如果找到了数据，则为布尔值。
