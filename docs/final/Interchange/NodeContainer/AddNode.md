...
在容器中添加一个节点，该节点将被添加到一个 TMP 中。

目标是互换基础节点容器

## 图示

![](/uploads/projects/ue-bluprint/20221218-19354667.png)
...
返回值。String. : 返回所添加项目的节点唯一 ID。如果该节点已经存在，它将返回现有的 ID。如果节点不能被添加，返回 InvalidNodeUid。
