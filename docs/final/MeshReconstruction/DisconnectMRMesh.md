...
解除当前程序网格组件与网格追踪系统的链接。

目标是 Mock Data Mesh Tracker 组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-20050971.png)

## Inputs

在。执行。

目标。Mock Data Mesh Tracker 组件对象参考。

在 MRMesh Ptr。MRMesh 组件对象参考。从网格跟踪系统中解除链接的程序性网格组件。
