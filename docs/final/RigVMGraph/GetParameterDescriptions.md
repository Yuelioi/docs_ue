...
返回这个 Graph.中唯一的 Parameter 描述的列表。多个参数节点可以共享相同的描述。

目标是 Rig VMGraph

## 图示

![](/uploads/projects/ue-bluprint/20221218-20442891.png)
...
返回值。Rig VMGraph Parameter Description 结构的数组。返回该图中唯一的参数描述列表。多个参数节点可以共享相同的描述。
