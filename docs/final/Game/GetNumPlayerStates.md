...
返回活跃的玩家状态的数量，每个连接的玩家都有一个玩家状态，即使他们是一个远程客户端。到此为止的索引可以作为其他函数的PlayerStateIndex参数使用。
...
返回值。整数。返回活跃的玩家状态的数量，每个连接的玩家都有一个玩家状态，即使他们是一个远程客户端。到此为止的索引可以作为其他函数的PlayerStateIndex参数使用。
