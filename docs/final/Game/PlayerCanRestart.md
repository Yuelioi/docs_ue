...
如果调用 RestartPlayer 是有效的，则返回 true。默认情况下会调用 Player->CanRestartPlayer。

目标是游戏模式基础

## 图示

![](/uploads/projects/ue-bluprint/20221218-19072559.png)
...
返回值。布尔值。如果调用 RestartPlayer 是有效的，则返回 true。默认情况下会调用 Player->CanRestartPlayer。
