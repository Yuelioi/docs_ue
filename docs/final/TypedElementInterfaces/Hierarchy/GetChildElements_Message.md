# GetChildElements_Message

获取这个元素的逻辑子女，如果有的话。 eg）一个角色可能会返回它的组件，或者一个 ISM 组件可能会返回它的静态网格实例。

注：附加到 OutElementHandles。

目标是类型化的元素层次结构界面

## 图示

![](/uploads/projects/ue-bluprint/20221218-21173393.png)
...
Out Element Handles。脚本类型的元素处理结构的数组。
