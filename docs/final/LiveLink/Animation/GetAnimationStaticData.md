...
返回存储在主体框架中的主体的静态数据。如果没有找到有效的数据，则返回 false。

目标是 Live Link 蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-19444759.png)
...
动画静止数据。Live Link Skeleton 静态数据结构。

返回值。布尔值。返回存储在主体框架中的主体的静态数据。如果没有找到有效的数据，返回 false。
