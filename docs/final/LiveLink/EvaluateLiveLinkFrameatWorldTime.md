# EvaluateLiveLinkFrameatWorldTime

试图用一个给定的角色从受试者那里获得一个 LiveLink 框架

## 图示

![](/uploads/projects/ue-bluprint/20221218-19450677.png)
...
World Time: Float (double-precision). Float (double-precision) World Time. The World Time the subject will be evaluated to.
