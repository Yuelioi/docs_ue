...
客户端是否有启用此名称的主题。只能启用 1 个同名的主题。在画面开始时，将对启用的主题进行快照。该快照决定了在该帧的持续时间内将使用哪个主题。

目标是 Live Link 蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-19452073.png)
...
返回值。布尔值。客户端是否有启用此名称的主题。只能启用 1 个同名的主题。在帧开始时，将对启用的主体进行快照。该快照决定了在该帧的持续时间内将使用哪个主题。
