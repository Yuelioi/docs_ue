...
返回一个给定的 LiveLink Transform 是否有一个父级变换。

目标是 Live Link 蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-19451965.png)

## Inputs

活体链接转换。Live Link Transform 结构（按参考文献）。

## Outputs

返回值。布尔值。返回给定的 LiveLink 变换是否有父变换。
