...
删除一个文本到语音通道，阻止所有对该通道的文本到语音功能的进一步请求。如果提供的通道 ID 不存在，就不会发生任何事情。

目标是文字转语音引擎子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-21114280.png)
...
Channel Id: Name. The Id for the channel you want removed..
