...
返回当前在文本到语音通道上发声的字符串的语音速率。值在 0.0 和 1.0 之间。如果提供的通道 ID 不存在，将返回 0.0f。

目标是文字转语音引擎子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-21113434.png)
...
Channel Id: Name. The Id for the channel to get the speech rate from..
