...
![](/uploads/projects/ue-bluprint/20221218-18125864.png)
...
In Subpoint Name: String. Name of the subpoint to namespace.

## Outputs

Out Namespaced Name: String. The output namespaced subpoint name.
