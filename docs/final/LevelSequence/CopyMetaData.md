...
将指定的元数据复制到这个级别序列中，覆盖任何现有的相同类型的元数据。元数据可以实现 ILevelSequenceMetaData 接口，以便与默认的 ULevelSequence 功能挂钩。

目标是水平序列

## 图示

![](/uploads/projects/ue-bluprint/20221218-19410400.png)
...
返回值。对象参考。新复制的 Metadata 实例，现在存在于这个序列上。
