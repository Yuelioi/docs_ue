...
![](/uploads/projects/ue-bluprint/20221218-18434839.png)
...
每个属性的值。DMXAttribute Name 结构到整数的映射。
...
Value Per Attribute: Map of DMXAttribute Name Structures to Integers.
