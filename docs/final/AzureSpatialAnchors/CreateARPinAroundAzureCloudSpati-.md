# CreateARPinAroundAzureCloudSpati-

围绕一个已经存在的云锚创建一个 ARPin。

目标是 Azure 空间锚点库

## 图示

![](/uploads/projects/ue-bluprint/20221218-18100974.png)
...
在 Azure Cloud Spatial Anchor 中。Azure Cloud Spatial Anchor Object Reference. 我们要创建针脚的云锚。

## Outputs

输出。Exec.

Out ARPin: ARPin 对象参考。所创建的针，或为空。

返回值。Boolean. (布尔值) 如果我们能够创建...，则为真。
