...
检索默认的MIDI输入设备ID。事先调用 "查找所有MIDI设备信息 "来列举可用的输入设备。

目标是MIDID设备管理器

## 图示

![]($-20221218-20054373.png)
...
Device ID: Integer. The Device ID of the MIDI input device with that name..
