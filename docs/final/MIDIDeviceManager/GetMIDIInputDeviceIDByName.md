...
按名称检索 MIDI 输入设备 ID。事先调用 "查找所有 MIDI 设备信息 "来列举可用的输入设备。

目标是 MIDID 设备管理器

## 图示

![](/uploads/projects/ue-bluprint/20221218-20054612.png)

## Inputs

在。执行。

设备名称。字符串。你想与之对话的 MIDI 设备的名称。

## Outputs

出：执行。

设备 ID：整数。该名称的 MIDI 设备的设备 ID。
