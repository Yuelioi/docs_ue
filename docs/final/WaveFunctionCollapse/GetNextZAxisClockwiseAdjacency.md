...
获取给定邻接点的 Z 轴上顺时针方向的下一个邻接点。例如，GetNextZAxisClockwiseAdjacency(Front)将返回右侧。向上或向下将返回原来的邻接点。

目标是波函数崩溃 BPLibrary

## 图示

![](/uploads/projects/ue-bluprint/20221218-21325567.png)

## Inputs

相邻关系。EWaveFunctionCollapseAdjacency 枚举。邻接方向。
...
Adjacency: EWaveFunctionCollapseAdjacency Enum. Adjacency direction.
