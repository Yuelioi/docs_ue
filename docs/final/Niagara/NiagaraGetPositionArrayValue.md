# NiagaraGetPositionArrayValue

获取一个 Niagara Array Position 中的单个值。

目标是 Niagara 数据接口阵列函数库

## 图示

![](/uploads/projects/ue-bluprint/20221218-20123831.png)
...
Return Value: Vector. Gets a single value within a Niagara Array Position..
