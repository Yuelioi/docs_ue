...
返回世界空间中被 ConsumeInputVector()处理的最后一个输入向量，这通常是由 Pawn 或 PawnMovementComponent 完成的。任何需要了解最后影响运动的输入的用户都应该使用这个函数。

目标是卒子运动组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-20184370.png)
...
返回值。矢量。世界空间中被 ConsumeInputVector()处理的最后一个输入向量。
