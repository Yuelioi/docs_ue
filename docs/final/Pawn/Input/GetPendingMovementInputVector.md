...
返回世界空间中的待定输入向量。这是输入向量的最新值，等待 ConsumeMovementInputVector()来清除它，。通常只有 PawnMovementComponent 会想要读取这个值，如果 Pawn 负责运动的话，它自己也会想要读取。

目标是卒子

## 图示

![](/uploads/projects/ue-bluprint/20221218-20191784.png)
