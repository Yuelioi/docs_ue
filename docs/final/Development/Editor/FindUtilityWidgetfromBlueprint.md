...
给出一个编辑器实用部件的蓝图，获得它所创建的部件。如果该部件目前不在一个标签中，这将返回一个空指针。

目标是编辑实用程序子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-18421375.png)
...
返回值。编辑器实用部件对象参考。给定一个编辑器实用小部件蓝图，获得它所创建的小部件。如果该部件目前不在一个标签中，这将返回一个空指针。
