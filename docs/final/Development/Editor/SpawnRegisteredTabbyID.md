...
给定一个标签的 ID，尝试找到一个匹配的标签生成器，然后生成一个标签。如果它能够找到一个匹配的标签生成器，返回 true。

目标是编辑实用程序子系统

## 图示

![](/uploads/projects/ue-bluprint/20221218-18423446.png)
...
返回值。布尔值。给定一个标签的 ID，尝试找到一个匹配的标签生成器，然后生成一个标签。如果它能够找到一个匹配的标签页生成器，返回 true。
