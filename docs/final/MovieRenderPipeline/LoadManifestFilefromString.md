# LoadManifestFilefromString

加载指定的清单文件并将其转换为 UMoviePipelineQueue。与 SaveQueueToManifestFile 结合使用。

目标是电影管道蓝图库

## 图示

![](/uploads/projects/ue-bluprint/20221218-20092747.png)
...
返回值。电影管道队列对象参考。加载指定的清单文件并将其转换为 UMoviePipelineQueue。与 SaveQueueToManifestFile.结合使用。
