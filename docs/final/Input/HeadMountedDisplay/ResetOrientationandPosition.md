...
通过将滚动和俯仰设置为 0 来重置方向，假设当前的偏航为前进方向，并假设。当前位置为'零点'（用于位置跟踪）。

目标是头戴式显示器功能库

## 图示

![](/uploads/projects/ue-bluprint/20221218-19240677.png)

## Inputs

在。执行。

偏航。Float（单精度）。(in)方向重置后要设置的期望偏航。

选项。EOrientPositionSelector 枚举。(in)指定位置、方向或两者都应该被重置。
