# HasMappingContext_Message

检查是否有映射上下文应用于该子系统的所有者。// TODO: BlueprintPure 会更好。移到库中？

目标是增强型输入子系统接口

## 图示

![](/uploads/projects/ue-bluprint/20221218-19271933.png)
...
返回值。布尔值。检查是否有映射上下文应用于该子系统的所有者。// TODO: BlueprintPure 会更漂亮。移动到库中？
