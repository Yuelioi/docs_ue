...
如果这是一个包中的主要资产，则返回 true，对于地图和资产来说是 true，但对于类重定向器等次要对象来说是 false。

目标是资产注册帮助器

## 图示

![](/uploads/projects/ue-bluprint/20221218-17594868.png)
...
返回值。布尔值。如果这是一个包中的主要资产，则返回 true，对于地图和资产来说是 true，但对于类重定向器等次要对象来说是 false。
