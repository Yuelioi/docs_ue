...
设置 GeometryCache 的当前动画时间。包括已过时间和 SetStartTimeOffset 的影响。

目标是 Geometry Cache 组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-18235879.png)
...
返回值。Float（单精度）。设置 GeometryCache 的当前动画时间。包括已过时间和 SetStartTimeOffset 的影响。
