# GetUnscaledCapsuleHalfHeightWith-

返回胶囊的半高减去半径（不包括半球形），忽略组件的缩放。这不包括半球形的端盖。从胶囊的中心开始，这是沿直线圆柱形部分到顶部半球的曲线开始前的垂直距离。

目标是胶囊的碰撞

## 图示

![](/uploads/projects/ue-bluprint/20221218-18230876.png)
...
返回值。Float（单精度）。胶囊的半高减去半径，忽略分量的缩放。
