...
获取指定实例的变换。除非设置了 bWorldSpace，否则实例将以该组件的本地空间返回。成功时返回 True。

目标是实例化的静态网格组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-18244014.png)
...
返回值。布尔值。获取指定实例的变换。除非设置了 bWorldSpace，否则实例将以这个组件的本地空间返回。成功时返回 True。
