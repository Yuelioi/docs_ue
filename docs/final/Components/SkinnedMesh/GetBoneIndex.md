...
按名称查找骨骼的索引。在当前被这个 SkeletalMeshComponent 使用的 SkeletalMesh 中查找。

目标是带皮的网格组件

## 图示

![](/uploads/projects/ue-bluprint/20221218-18263938.png)
...
返回值。整数。当前 SkeletalMesh 中指定骨骼的索引。如果没有找到骨头，将返回 INDEX_NONE。
