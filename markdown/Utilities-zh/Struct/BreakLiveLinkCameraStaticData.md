# BreakLiveLinkCameraStaticData

Adds a node that breaks a 'LiveLinkCameraStaticData' into its member fields

## 图示

![]($-20221218-14391874.png)

## Inputs

Live Link Camera Static Data: Live Link Camera Static Data Structure (by ref).  
