# BreakSoundSubmixSendInfo

Adds a node that breaks a 'SoundSubmixSendInfo' into its member fields

## 图示

![]($-20221218-14431291.png)

## Inputs

Sound Submix Send Info: Sound Submix Send Info Structure (by ref).  
