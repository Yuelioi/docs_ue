# BreakWorldPartitionStreamingQuer-

Adds a node that breaks a 'WorldPartitionStreamingQuerySource' into its member fields

## 图示

![]($-20221218-14460114.png)

## Inputs

World Partition Streaming Query Source: World Partition Streaming Query Source Structure (by ref).  
