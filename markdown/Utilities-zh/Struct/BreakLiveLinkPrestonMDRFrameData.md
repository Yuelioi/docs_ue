# BreakLiveLinkPrestonMDRFrameData

Adds a node that breaks a 'LiveLinkPrestonMDRFrameData' into its member fields

## 图示

![]($-20221218-14392687.png)

## Inputs

Live Link Preston MDRFrame Data: Live Link Preston MDRFrame Data Structure (by ref).  
