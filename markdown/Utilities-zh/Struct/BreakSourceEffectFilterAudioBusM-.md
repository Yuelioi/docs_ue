# BreakSourceEffectFilterAudioBusM-

Adds a node that breaks a 'SourceEffectFilterAudioBusModulationSettings' into its member fields

## 图示

![]($-20221218-14432751.png)

## Inputs

Source Effect Filter Audio Bus Modulation Settings: Source Effect Filter Audio Bus Modulation Settings Structure (by ref).  
