...
Adds a node that create a 'EditorScriptingCreateProxyMeshActorOptions_Deprecated' from its members

## 图示

![]($-20221218-14522026.png)
...
Editor Scripting Create Proxy Mesh Actor Options Deprecated: Editor Scripting Create Proxy Mesh Actor Options Deprecated Structure.
