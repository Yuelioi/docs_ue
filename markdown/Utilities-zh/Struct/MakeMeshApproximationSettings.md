# MakeMeshApproximationSettings

Adds a node that create a 'MeshApproximationSettings' from its members

## 图示

![]($-20221218-14573534.png)
...
Mesh Approximation Settings: Mesh Approximation Settings Structure.
