...
Adds a node that breaks a 'DatasmithOpenNurbsOptions' into its member fields
...
Datasmith Open Nurbs Options: Datasmith Open Nurbs Options Structure (by ref).  

## Outputs

Geometry: EDatasmithOpenNurbsBrepTessellatedSource Enum. Geometry.
