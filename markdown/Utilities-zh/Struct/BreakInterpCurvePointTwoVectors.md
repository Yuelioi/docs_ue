# BreakInterpCurvePointTwoVectors

添加一个节点，将'InterpCurvePointTwoVectors'分解到其成员字段中

## 图示

![]($-20221218-14383881.png)

## Inputs

Interp Curve Point Two Vectors:Interp Curve Point Two Vectors结构（由参考文献）。  
