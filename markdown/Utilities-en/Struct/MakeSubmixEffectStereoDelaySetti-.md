# MakeSubmixEffectStereoDelaySetti-

Adds a node that create a 'SubmixEffectStereoDelaySettings' from its members

## 图示

![]($-20221218-15024954.png)
...
Submix Effect Stereo Delay Settings: Submix Effect Stereo Delay Settings Structure.
