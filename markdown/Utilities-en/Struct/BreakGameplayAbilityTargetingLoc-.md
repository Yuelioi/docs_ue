# BreakGameplayAbilityTargetingLoc-

Adds a node that breaks a 'GameplayAbilityTargetingLocationInfo' into its member fields

## 图示

![]($-20221218-14362426.png)

## Inputs

Gameplay Ability Targeting Location Info: Gameplay Ability Targeting Location Info Structure (by ref).  
