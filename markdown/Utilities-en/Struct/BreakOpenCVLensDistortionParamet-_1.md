# BreakOpenCVLensDistortionParamet-_1

Adds a node that breaks a 'OpenCVLensDistortionParametersBase' into its member fields

## 图示

![]($-20221218-14405828.png)

## Inputs

Open CVLens Distortion Parameters Base: Open CVLens Distortion Parameters Base Structure (by ref).  
