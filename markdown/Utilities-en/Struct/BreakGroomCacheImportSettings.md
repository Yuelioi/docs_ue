# BreakGroomCacheImportSettings

Adds a node that breaks a 'GroomCacheImportSettings' into its member fields

## 图示

![]($-20221218-14375038.png)

## Inputs

Groom Cache Import Settings: Groom Cache Import Settings Structure (by ref).  
