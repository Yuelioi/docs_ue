# MakeOpenCVLensDistortionParamete-_1

Adds a node that create a 'OpenCVLensDistortionParametersBase' from its members

## 图示

![]($-20221218-14585281.png)
...
Open CVLens Distortion Parameters Base: Open CVLens Distortion Parameters Base Structure.
