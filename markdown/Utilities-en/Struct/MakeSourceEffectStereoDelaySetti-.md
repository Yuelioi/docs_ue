# MakeSourceEffectStereoDelaySetti-

Adds a node that create a 'SourceEffectStereoDelaySettings' from its members

## 图示

![]($-20221218-15021781.png)
...
Source Effect Stereo Delay Settings: Source Effect Stereo Delay Settings Structure.
