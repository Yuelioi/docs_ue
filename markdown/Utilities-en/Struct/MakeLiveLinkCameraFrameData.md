# MakeLiveLinkCameraFrameData

Adds a node that create a 'LiveLinkCameraFrameData' from its members

## 图示

![]($-20221218-14565199.png)
...
Live Link Camera Frame Data: Live Link Camera Frame Data Structure.
