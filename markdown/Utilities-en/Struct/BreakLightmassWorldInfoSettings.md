...
Adds a node that breaks a 'LightmassWorldInfoSettings' into its member fields
...
Lightmass World Info Settings: Lightmass World Info Settings Structure (by ref).  
