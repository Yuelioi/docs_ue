...
Adds a node that create a 'SourceEffectMotionFilterSettings' from its members
...
Source Effect Motion Filter Settings: Source Effect Motion Filter Settings Structure.
